        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-10">
          ...
          <div className="border-t-2 border-cyan-100 pt-8">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 p-6 rounded-xl mb-6 border border-orange-200 shadow-sm">
              ...
              <div className="space-y-3 mb-4">
                {(['Texto', 'Foto', 'Documentos'] as const).map((tipo) => (
              ...
              {formData.tipoEvidencia === 'Foto' && (
                <div className="bg-white p-4 rounded-xl border-2 border-slate-200 mb-4 shadow-sm">
                  ...
                  <input
                    ...
                    accept="image/*"
                    required
                    onChange={(e) => updateFormData({ evidenciaFoto: e.target.files?.[0] ?? null })}
                  ...
                  {formData.evidenciaFoto && (
                    <p className="text-sm text-orange-600 mt-2 font-medium">✓ Archivo seleccionado: {(formData.evidenciaFoto as File).name}</p>
                  )}
                </div>
              )}
              ...
              {formData.tipoEvidencia === 'Documentos' && (
                <div className="bg-white p-4 rounded-xl border-2 border-slate-200 mb-4 shadow-sm">
                  ...
                  <input
                    ...
                    required
                    onChange={(e) => updateFormData({ evidenciaDocumento: e.target.files?.[0] ?? null })}
                  ...
                  {formData.evidenciaDocumento && (
                    <p className="text-sm text-cyan-600 mt-2 font-medium">✓ Archivo seleccionado: {(formData.evidenciaDocumento as File).name}</p>
                  )}
                </div>
              )}
            </div>
          ...
          <div className="border-t-2 border-cyan-100 pt-8">
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-6 rounded-xl border border-cyan-200 shadow-sm">
              ...
              {formData.ubicacionLat && formData.ubicacionLng && (
                <div className="bg-white p-4 rounded-lg border-l-4 border-orange-500 mb-4 shadow-sm">
                  ...
                  <p className="text-orange-900 font-medium">
                    Latitud: {(formData.ubicacionLat as number).toFixed(6)}, Longitud: {(formData.ubicacionLng as number).toFixed(6)}
                  </p>
                </div>
              )}
              ...
              <InteractiveMap
                center={mapCenter}
                ubicacionLat={formData.ubicacionLat as number | null}
                ubicacionLng={formData.ubicacionLng as number | null}
